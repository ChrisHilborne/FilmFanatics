...
public class FilmCinematographerSearch implements FilmSearchStrategy {

  private final FilmRepository repository;

  public FilmCinematographerSearch(FilmRepository repository) {
    this.repository = repository;
  }

  @Override
  public Set<Film> searchFilm(String searchParam) {
    return repository.findByFilmCinematographersNameContainsOrFilmCinematographersSurnameContainsAllIgnoreCase(searchParam, searchParam);
  }
}
